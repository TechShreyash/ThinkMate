...
[performance_and_scaling.md](performance_and_scaling.md#horizontal-scale-migration-path-future).
The data model, prompts, memory algorithms, and service APIs do not change.
